...
//   //insert query5
   $query5 = "INSERT INTO clientoffer (jobType, jobdescription,jobSkill,jobDuration,jobPayment,jobRate, outcome1, outcome2, outcome3) values ('$jobType', '$jobdescription', '$a', '$jobDuration', '$jobPayment', '$jobRate', 'uploads/$Art11','uploads/$Art22','uploads/$Art33')";
