...
if(isset($_POST['submit'])){
  ...
  //insert query
  $query="INSERT INTO clientpayment (clientCardNo, clientCardName,clientCardExpired, clientCCV ) values ('$clientCardNo', '$clientCardName','$clientCardExpired','$clientCCV' )";
