...
$fetched_row1 = mysqli_fetch_array($offerResult);
// $row = mysqli_fetch_row($freelancerResult);
// var_dump($row);
$result3 = mysqli_query($con, "SELECT * FROM client ");
$result2 = mysqli_query($con, "SELECT * FROM clientartwork clientID");
$fetched_row = mysqli_fetch_array($result3);
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="editProfile1.php" class="btn btn-primary btn-block"><b>Approve Offer</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
