        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo $fetched_row['freeProfile']?>" alt="User profile picture">

              <h3 class="profile-username text-center"><?php echo $fetched_row['freeName']; ?></h3>

              <p class="text-muted text-center"><?php echo $fetched_row['freeInterest']; ?></p>
              ...
              <a href="editProfile2.php" class="btn btn-primary btn-block"><b>Edit Profile</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted"><?php echo $fetched_row['freeAddress']; ?></p>
              ...
              <p>
               <?php echo $fetched_row['freeSkillType']; ?>
              </p>
                  ...
                  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="<?php echo $fetched_row['freeArtwork1']?>" alt="First slide">
                
                        <div class="carousel-caption">
                          <strong>First Slide</strong>
                        </div>
                        <p><strong><?php echo $fetched_row['freeArtworkDescription1']?></strong></p>
                      </div>
                      <div class="item">
                        <img src="<?php echo $fetched_row['freeArtwork2']?>" alt="Second slide">
                
                        <div class="carousel-caption">
                         <strong> Second Slide </strong>
                        </div>
                        <p><strong><?php echo $fetched_row['freeArtworkDescription2']?></strong></p>
                      </div>
                      <div class="item">
                        <img src="<?php echo $fetched_row['freeArtwork3']?>" alt="Third slide">
                
                        <div class="carousel-caption">
                          <strong>Third Slide</strong>
                        </div>
                       <p><strong><?php echo $fetched_row['freeArtworkDescription3']?></strong></p>
                      </div>
                    </div>
