	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><span>ProClient</span></a>
			</div>
		...
		<div class="row">
			<div class="slider">
				<div class="img-responsive">
					<ul class="bxslider">				
						<li><img src="img/index1.png" alt=""/></li>								
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-3">
				<div class="text-center">
					<h2>WHO are ProClient?</h2>
					<p>We ProClient are a new e-MarketPlace that help Client to meet their preferance Freelancer<br>
					Here we will provide for both user a FREE platform to join in our community <br>
					New freelancer and client also enstablish themself here by maintaince good reputation here.
					</p>
				</div>
				<hr>
			</div>
			...
			<div class="box">
				<div class="col-md-4">
					<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.4s">
						...
						<p>We try our best to provide a very dynamic website and we also make research on user experience to make easier for our users.</p>
						<div class="ficon">
				...
				<div class="col-md-4">
					<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.0s">
						...
						<p>Here client and freelancer can offer and find three type of project which are categories as Design, Mobile Application and Web Application.</p>
						<div class="ficon">
				...
				<div class="col-md-4">
					<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.6s">
						...
						<p>As this e-marketplace only offers three category of offer, they can easliy find each other in this platform.</p>
						<div class="ficon">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="text-center">
					<h2>Best from Best</h2>
					<p>Here we share some of the best Product that release in our platform.<br>
					All of this picture get high rate from both client and freelancer. <br>
					</p>
				</div>
				<hr>
			</div>
	...
	<div class="content">
		<div class="grid">
			<figure class="effect-zoe">
				...
				<figcaption>
					<h2>Design <span>Poster</span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
						<a href="#"><span class="icon-eye"></span></a>
						<a href="#"><span class="icon-paper-clip"></span></a>
					</p>
					<p class="description">Freelancer ID:123
					<br>CLient ID: 321</p>
				</figcaption>			
			</figure>
			<figure class="effect-zoe">
				...
				<figcaption>
					...
					<p class="description">Freelancer ID:456
					<br>CLient ID: 654</p>
				</figcaption>			
			</figure>
		</div>
	...
	<div class="content">
		<div class="grid">
			<figure class="effect-zoe">
				...
				<figcaption>
					<h2>Web <span>Application</span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
						<a href="#"><span class="icon-eye"></span></a>
						<a href="#"><span class="icon-paper-clip"></span></a>
	...
	<footer>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 f-about">
						<a href="index.php"><h1><span>Go </span>Up</h1></a>
					...
					<div class="col-md-4 f-contact">
						...
						<a href="#"><p><i class="fa fa-envelope"></i> ProClient@gmail.com</p></a>
						<p><i class="fa fa-phone"></i> +6010-8359052</p>
						<p><i class="fa fa-home"></i> ProClient inc  |  UPM, Serdang,  <br>
							434000, Malaysia</p>
					</div>
				</div>
			</div>
		...
		<div class="last-div">
			<div class="container">
				<div class="row">
					<div class="copyright">
						© 2017 ProClient Sdn Bhd theme | <a target="_blank" href="http://bootstraptaste.com">27/12/2017</a>
					</div>	
                    <!-- 
