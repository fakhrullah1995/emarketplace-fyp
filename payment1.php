  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="payment1.php"><i class="fa fa-fw fa-money"></i> <span>Payment</span></a></li>
        <li><a href="profile1.php"><i class="fa fa-fw fa-user"></i> <span>Profile</span></a></li>
        <li class="treeview">
          <a href="offerjob1.php"><i class="fa fa-fw fa-briefcase"></i> Offer Job</span>
