  ...
  <aside class="main-sidebar">
      ...
      <!-- /.search form -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"> <a href="contest1.php">Open Contest</a> </li>
          </ul>
        </li>
      </ul>
        <!-- /.sidebar-menu -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Post Contest
          <small>Contest on valid for designing</small>
        </h1>
        <ol class="breadcrumb">
          <li>
            <a href="#">
              <i class="fa fa-dashboard"></i>Contest</a>
          </li>
        ...
        <div class="box box-info">
          ...
          <form action="contestDB.php"  method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group">
              <label  class="col-sm-2 control-label">Type of Design</label>
              <div class="col-sm-5">
                <div class="input-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <div class="input-group">
                  ...
                  <input class="form-control" id="contestDuration" name= "contestDuration" placeholder="Enter duration you want your job completed in day">
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <div class="input-group">
                    ...
                    <input  class="form-control" id="contestPayment" name="contestPayment" placeholder="Enter total payment for this contest">
                  </div>
                </div>
              </div>
